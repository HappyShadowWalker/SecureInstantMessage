...
#include <QLabel>
#include <QPainter>
changeSkinWidget::changeSkinWidget(QString picName,QWidget *parent) :
    QWidget(parent)
{
    bgPicName=picName;
...
void changeSkinWidget::paintEvent(QPaintEvent *){
    ...
    painter.setBrush(QBrush(QPixmap(bgPicName)));
    painter.setRenderHints(QPainter::Antialiasing,true);
    painter.setPen(Qt::black);
    painter.drawRect(rect());
}

void changeSkinWidget::setSkin(QString picName){
    bgPicName=picName;
    update();
}
